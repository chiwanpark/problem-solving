...
namespace LECTURE {
int encode(string s) { return ((int)((s[0] - 'a')) << 8) + (int)(s[1] - 'a'); }

string decode(int i) { return string(1, (char)('a' + (i >> 8))) + string(1, (char)('a' + (i & 0xFF))); }
...
int main(int argc, const char *argv[]) { return LECTURE::do_main(argc, argv); }
